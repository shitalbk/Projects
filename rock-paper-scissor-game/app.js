...
const combine = (resultHandler,operation, ...numbers) => {    // Rest operator
    const validateNumber = (number) => {  // function inside function
...
const showResult = (messageText,result) => {    // Callback Function
    alert(messageText + ' ' + result);
};

combine(showResult.bind(this,'The result after adding all number is:'),'ADD',5,4,-3,6,10);
